...
import { setStockOverlap, TickerOverlapPayload } from "../../../redux/equities/actions/etfOverlapActions"
...
export const PortfolioOverlap: React.FunctionComponent<PortfolioOverlapProps> = ({ ...props }) => {
    ...
    return (
        <>
            <div style={{ display: 'flex' }}>
                <OverlapDetails overlappingHoldings={overlappingHoldings} commonStocks={commonStocks} />
                <DisplayCommonStocks overlappingHoldings={overlappingHoldings} commonStocks={commonStocks} />
            </div>
        </>
    )
}