...
export const WalletGraph: React.FunctionComponent<WalletGraphType> = ({
  ...props
}) => {
  ...
  const tokenPrice = useSelector(
    (state: ReduxRootState) => state.crypto.tokenPrice
  );
                ...
                label: function (tooltipItem: TooltipItem<"bar" | "line">) {
                  switch (tooltipItem.datasetIndex) {
                    ...
                    case 1:
                      ...
                      return `Cumulative rewards in fiat: ${Intl.NumberFormat(
                        "en-AU",
