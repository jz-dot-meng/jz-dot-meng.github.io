...
export const StroopEffect = () => {
    ...
    const stroopConfig = {
        gameDetails: {
            'Initial': [{ data: 'Timer: 0', justifyContent: 'flex-start' }, { data: 'Score: 0', justifyContent: 'flex-end' }],
            'PlayGame': [{ data: `Timer: ${time.toFixed(3)}`, justifyContent: 'flex-start' }, { data: `Score: ${score}`, justifyContent: 'flex-end' }],
            'GameOver': [{ data: 'Game over!', justifyContent: 'flex-start' }, { data: `Score: ${score}`, justifyContent: 'flex-end' }]
        },
        gameControls: {
            'Initial': [{ buttonText: 'Start game', onClick: startGame }],
            'PlayGame': [{ buttonText: '&#60;&nbsp;&nbsp;no match', onClick: noMatch }, { buttonText: 'match&nbsp;&nbsp;&#62;', onClick: match }],
